...
const DetailForm = ({setPaypalButtonDisable}) => {
    ...
    const handleCountryChange = (e) => {
      ...
      const handleSubmit = (e) => {
        ...
        if(firstNameFlag && lastNameFlag && phoneNumnerFlag && emailFlag && address && state && postalCode){
            localStorage.setItem("address" , address + " " + postalCode)
            swal({
            title: "Address Added!",
                ...
                <div className="row g-2">
                    ...
                    <div className="col-sm-6">
                        ...
                        <Box>
                            ...
                            placeholder="902-902-9020" margin="normal" fullWidth
                    ...
                    <div className="col-sm-6">
                       <Box>
                            ...
                            placeholder="john@xyz.com" margin="normal" fullWidth
                        ...
                        <button className="btn btn-outline-secondary mt-4" type="submit" onClick={handleSubmit} disabled={isDisabled}>Submit Delivery Address</button>
            </form>
